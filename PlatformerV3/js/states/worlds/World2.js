var World2 = function (game) { }

World2.prototype =
{
    preload: function () { 

        this.game.load.tilemap('map1', 'TiledMap/level2-1.json', null, Phaser.Tilemap.TILED_JSON);
        this.game.load.tilemap('map2', 'TiledMap/level1-2.json', null, Phaser.Tilemap.TILED_JSON);
        this.game.load.tilemap('map3', 'TiledMap/level2-3.json', null, Phaser.Tilemap.TILED_JSON);
        ...
        background = this.game.load.image('desert', 'assets/Background/world2.png');

        this.game.physics.startSystem(Phaser.Physics.ARCADE);
        setWorld(2);
        //this.player = new Player(this.game, 2800, 960);
    ...
    changeMap: function (mapDraw,firstRedCoinposition, firstCoinposition, firstTime) {
        ...
        background = game.add.sprite(0, 0, 'desert');
        ...
        {
            mobPos = 0;
            map.createFromObjects('layerObj', 32, 'skeleton', 0, true, false, enemies);
        ...
        if(mapDraw.valueOf() === "map1" && !getData(9))
        {
            powerUp.enableBody = true;
            map.createFromObjects('layerObj', 23, 'powersUp', 1, true, false, powerUp);
        }
